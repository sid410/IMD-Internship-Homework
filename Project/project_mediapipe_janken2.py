...
gesture_images = {
    "rock": cv2.imread("Project/Resources/rock.png"),
    "scissors": cv2.imread("Project/Resources/scissors.png"),
    "paper": cv2.imread("Project/Resources/paper.png")
}
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if npc_gesture is not None:
            ...
            if npc_gesture in gesture_images and gesture_images[npc_gesture] is not None:
                npc_image = cv2.resize(gesture_images[npc_gesture], (200, 200))
                image[250:450, 50:250] = npc_image
